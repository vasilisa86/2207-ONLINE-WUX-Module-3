    ...
    var loadMyCartEvent = function (targetSelector) {
        ...
        if (!$("#" + idCartModal).length) {
            $('body').append(
                ...
                '<h1 class="modal-title" id="myModalLabel"><h1 class="bx bx-shopping-bag"></h1> My Cart</h1>' +
                '</div>' +
        ...
        if (options.affixCartIcon) {
            var cartIconBottom = $cartIcon.offset().top * 0 + $cartIcon.css("height").match(/\d+/) * 0;
