...
function createBook(title, author, genre, price, owner, image) {
    ...
    // Create the edit and remove buttons with the required attributes
  ...
  localStorage.setItem("books", JSON.stringify(books));
    ...
    // Append the edit and remove buttons to the section
...
function editBook(bookId) {
    ...
    // Create an edit form with input fields for each book property
    ...
    // Replace the book section with the edit form
    bookSection.replaceWith(editForm);
}
