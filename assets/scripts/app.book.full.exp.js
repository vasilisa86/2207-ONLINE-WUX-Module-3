...
const bindingInput = document.getElementById("create-binding");
const markingInput = document.getElementById("create-marking");
const conditionInput = document.getElementById("create-condition");
...
if (books.length > 0) {
    books.forEach((book) => {
        createBook(book.title, book.author, book.binding, book.genre, book.price, book.owner, book.condition, book.marking, book.image, book.id);
    });
}
...
function createBook(title, author, binding, genre, price, owner, condition, marking, image, id) {
    ...
    const bindingElem = document.createElement("p");
    bindingElem.setAttribute("id", "book-binding");
    bindingElem.textContent = binding;

    const conditionElem = document.createElement("p");
    conditionElem.setAttribute("id", "book-condition");
    conditionElem.textContent = condition;

    const markingElem = document.createElement("p");
    markingElem.setAttribute("id", "book-marking");
    markingElem.textContent = marking;
    ...
    descriptionDsc.appendChild(markingElem);
    descriptionDsc.appendChild(bindingElem);
    descriptionDsc.appendChild(conditionElem);
...
function renderBook(book) {
    ...
    // Update the binding
    const bindingElem = bookSection.querySelector("#book-binding");
    bindingElem.textContent = book.binding;
    ...
    // Update the owner
    const conditionElem = bookSection.querySelector("#book-condition");
    conditionElem.textContent = book.condition;

    // Update the owner
    const markingElem = bookSection.querySelector("#book-marking");
    markingElem.textContent = book.marking;
}
